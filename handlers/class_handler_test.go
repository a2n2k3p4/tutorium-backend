...
func TestGetClass_OK(t *testing.T) {
	...
	RunInDifferentStatus(t,
		func(t *testing.T, mock sqlmock.Sqlmock, gdb *gorm.DB, app *fiber.App, payload *[]byte, uID *uint) {
			...
			ExpSelectByColumn("class_sessions", "class_id", classID, []string{"id"}, nil)(mock)
			*uID = userID
		},
		http.StatusOK,
		http.MethodGet,
...
func TestAddClassCategories_InvalidClassID(t *testing.T) {
	userID := uint(42)
	body := []byte(`{"class_category_ids":[1]}`)
	...
	RunInDifferentStatus(t,
		...
		http.StatusBadRequest,
		http.MethodPost,
		"/classes/abc/categories",
	)
}

func TestAddClassCategories_InvalidBody(t *testing.T) {
	userID := uint(42)
...
func TestAddClassCategories_NoIDs(t *testing.T) {
	userID := uint(42)
	body := jsonBody(map[string]any{"class_category_ids": []uint{}})
...
func TestAddClassCategories_ClassNotFound(t *testing.T) {
	userID := uint(42)
	body := jsonBody(map[string]any{"class_category_ids": []uint{1}})
	classID := uint(10)
...
func TestDeleteClassCategories_InvalidClassID(t *testing.T) {
	userID := uint(42)
	body := []byte(`{"class_category_ids":[1]}`)
	...
	RunInDifferentStatus(t,
		...
		http.StatusBadRequest,
		http.MethodDelete,
		"/classes/xyz/categories",
	)
}

func TestDeleteClassCategories_BadBody(t *testing.T) {
	userID := uint(42)
...
func TestDeleteClassCategories_NoIDs(t *testing.T) {
	userID := uint(42)
	body := jsonBody(map[string]any{"class_category_ids": []uint{}})
...
func TestDeleteClassCategories_ClassNotFound(t *testing.T) {
	userID := uint(42)
	body := jsonBody(map[string]any{"class_category_ids": []uint{1}})
	classID := uint(99)
...
func TestGetClassCategoriesByClassID_InvalidID(t *testing.T) {
	userID := uint(42)
