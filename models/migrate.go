...
func Seed(db *gorm.DB) error {
	...
	return db.Transaction(func(tx *gorm.DB) error {
		...
		notificationRows := []Notification{
			{UserID: userBySID[userKeys[1]].ID, NotificationTitle: "Welcome", NotificationType: "Learner", NotificationDescription: "Welcome!", NotificationDate: now, ReadFlag: false},
			{UserID: userBySID[userKeys[1]].ID, NotificationTitle: "Enrollment successful", NotificationType: "Learner", NotificationDescription: "You enrolled successfully.", NotificationDate: now, ReadFlag: false},
			{UserID: userBySID[userKeys[2]].ID, NotificationTitle: "Review received", NotificationType: "Teacher", NotificationDescription: "Your class got a new review.", NotificationDate: now, ReadFlag: false},
			{UserID: userBySID[userKeys[1]].ID, NotificationTitle: "Password changed", NotificationType: "Learner", NotificationDescription: "Password changed.", NotificationDate: now, ReadFlag: true},
			{UserID: userBySID[userKeys[0]].ID, NotificationTitle: "New report", NotificationType: "Admin", NotificationDescription: "A report needs your attention.", NotificationDate: now, ReadFlag: false},
			{UserID: userBySID[userKeys[5]].ID, NotificationTitle: "Balance updated", NotificationType: "Teacher", NotificationDescription: "Balance updated.", NotificationDate: now, ReadFlag: false},
		}
